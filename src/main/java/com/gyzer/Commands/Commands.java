...
import com.gyzer.Commands.AdminCommands.*;
import com.gyzer.Commands.PlayerCommands.*;
import com.gyzer.Commands.PlayerCommands.DeleteCommand;
import com.gyzer.Commands.PlayerCommands.MoneyCommand;
...
public class Commands implements CommandExecutor, TabCompleter {
    ...
    private static final LegendaryGuild legendaryguild=LegendaryGuild.getLegendaryGuild();
    private static final Language lang=legendaryguild.getLanguageManager();
    ...
    public static void register(){
        ...
        admin_commands.put("position",new AdminPositionCommand());
        admin_commands.put("add",new AddCommand());
        admin_commands.put("kick",new AdminKickCommand());
        ...
        admin_commands.put("money",new com.gyzer.Commands.AdminCommands.MoneyCommand());
        ...
        admin_commands.put("delete",new DeleteCommand());

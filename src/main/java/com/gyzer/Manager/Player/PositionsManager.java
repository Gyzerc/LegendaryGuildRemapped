...
import com.gyzer.Configurations.Files.PositionConfig;
...
public class PositionsManager {
    ...
    private PositionConfig positionConfigManager;
    private HashMap<String, Position> cache;
    private Position defaultPosition;
    private Position ownerPosition;
    public PositionsManager( ){
        cache = new HashMap<>();
        positionConfigManager = new PositionConfig(this);
        MsgUtils.sendConsole("Load "+cache.size()+" Guild Positions.");
    }
